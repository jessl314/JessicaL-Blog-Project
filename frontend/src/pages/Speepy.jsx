        ...
        <Container className="mt-5">
            <Row className="align-items-start justify-content-start">
                <Col xs={8} md={4} className="d-flex justify-content-start mb-4 ms-0">
                   ...
                   <p>Technical: </p>
                    <p> - Github! This was my first time ever working with merging and branches (thus it was also my first time using fetch/pull.). I learned a lot about what it means to work on my own branch and also how that interconnects with what ends up on the finished product. Furthermore, I learned a lot about merge conflicts and how communication with the team can help to resolve them. This process had a lot of ups and downs involving frustrating merge conflicts and also excitement at seeing a feature that works correctly. Overall, I'm really glad that I got this experience as Github is such an integral part of software engineering.</p>
                    <p>I also learned about Unity and a little bit of C#. Not only did I learn about a software that was entirely new to me but it also improved my self-learning, problem-solving, and trouble-shooting skills as each new feature that I wanted to add, no matter how small required me to go search online or ask for help. It was also really fun to see how changing a couple settings on Unity can affect what we see on screen during gameplay</p>
                    <p>Non-technical</p>
                    <p>- teamwork: this was my first time ever contributing to a project that has lasted more than a two weeks (previously I've only ever participated in high school social studies group projects). This along with the fact that I would get to work with non-technical people such as artists, designers, audio people etc. was actually a major part of why I wanted to join a pitch project in the first place. I learned a lot about how to communicate what I have been doing in a way so that others can understand as well as how to integrate what others have created such as the background and sprites (moving components such as the character that flips in the bed). While I know that this is what could be called a "short" project it definitely gave me insight into what it's like to work towards a common goal in a group setting.
