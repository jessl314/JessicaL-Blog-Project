...
// displays all content/components related to my project Speepy
function Speepy () {
    return (
        <Container className="mt-5 speepy-container">
            <Row className="align-items-start justify-content-start">
                {/* Speepy Title and a couple screenshots on the left side of the screen */}
                ...
                <Col xs={8} md={8} className="d-flex mb-4 ms-0">
                  {/* for showing what I contributed and and what I learned */}
                    <div>
